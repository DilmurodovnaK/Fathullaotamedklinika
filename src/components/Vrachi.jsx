...
` Затруднение дыхания : пневмонии и постковидный синдром ,сложные формы бронхит. Нарушение тонуса мышц после травм , инсультов .Проявление возрастных изменений.`
    ...
    },
     {
      ...
      image: vrach2, 
      text:t("dok3text"),
       description: [`Все виды заболеваний излечиваются на основе их биоэнергетики.`,
        `Многие женские заболевания такие, как миомы, кистозные заболевания, эррозии, воспаления придатков, маститы, бесплодие и т.д.`,
        `Цирроз печени, все виды гепатита, гормональные нарушения, диабет, психические состояния людей и многие другие заболевания.`
      ]
    },
  ];
